...
import { useFetchPoolData } from '../../hooks/fetch';
...
function AllPoolsLayout() {
  ...
  const { loading: poolDataLoading, poolData } = useFetchPoolData(1);
              ...
              {poolDataLoading ? (
                ...
                <div className="flex flex-col items-center">
                  <div className="text-lg font-semibold mb-2">
                    Pool {poolData.id}: {poolData.tokenA.symbol}/{poolData.tokenB.symbol}
                  </div>
                  <div className="text-sm text-medium mb-4">
                    Liquidity: {poolData.liquidity}
                  </div>
                  <div className="text-sm text-medium">
                    Fee: {poolData.fee / 10000}%
                  </div>
                </div>
              ) : (
