...
function getAvailableCoins() {
    ...
    for (i = 0; i < tokenTab.length; i++) {
        ...
        $(".coinTab").html('').append('<li class="tab col s2" style="width: calc(100% / ' + tokenTab.length + ')!important;"><a href="#' + tokenTab[i] + '" style="color:#bbbaba;position: relative;padding: 0 12px 0px 35px;"><img src="/bitsAssets/images/currencies/' + allTokens[tokenTab[i].toLowerCase()].name.replace('-kovan', '') + '.png" style="width: 30px; position: absolute;top: 10px;left:5%!important;"> 1 ' + allTokens[tokenTab[i].toLowerCase()].name + ' = <span class="coindata-' + tokenTab[i].toLowerCase() + '-price">updating..</span><img src="/bitsAssets/images/flags/' + baseFl + '.png" style="width: 30px; position: absolute;top: 10px;right:5%!important;"></a></li>')
