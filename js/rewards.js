...
function getAvailableCoins() {
    ...
    for (i = 0; i < tokenTab.length; i++) {
        ...
        $(".coinTab").html('').append('<li class="tab col s2" style="width: calc(100% / ' + tokenTab.length + ')!important;"><a href="#' + tokenTab[i] + '" style="color:#bbbaba;position: relative;padding: 0 12px 0px 35px;"><img class="imgTab" src="/bitsAssets/images/currencies/' + allTokens[tokenTab[i].toLowerCase()].name.replace('-kovan', '') + '.png" style="width: 30px; position: absolute;top: 10px;"> 1 ' + allTokens[tokenTab[i].toLowerCase()].name + ' = <span class="coindata-' + tokenTab[i].toLowerCase() + '-price">updating..</span></a></li>')
