                                ...
                                if (parseInt(oDs[ii].tranTo.uid) == parseInt(localStorage.getItem('bits-user-name'))) {
                                    ...
                                    try {
                                        ...
                                        if ((coinba*0.9) > (parseFloat(oDs[ii].amount) * parseFloat(oDs[ii].rate)).toFixed(2)) {
                                            ...
                                            var bAc = '<a id="oid-act-' + oDs[ii].id + '"  class="waves-effect waves-light btn modal-trigger" href="#tradeOrder" oid="' + oDs[ii].id + '" act="sell" onlick="walletStatus()">SELL</a>';
