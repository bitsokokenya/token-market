                ...
                for (var ii in oDs) {
                    ...
                    if (oDs[ii].tranTo == 0 && oDs[ii].state == 'pending') {
                        ...
                        $("#orderbookSep").before('<tr class="element-' + oDs[ii].coin + '-coin element-all-coin" style="background-color:#ffdcdc;height: 40px;" >' +
                            '<td style="width:100%;" ><img src="' + oDs[ii].tranFrom.icon + '" style="width: 35px;float: left;position: relative;left: 20px;top: 5px;display: inline-block;"><span class="odbk-txt">' + oDs[ii].tranFrom.name + '</span></td>' +
                            '<td class="hidden-xs">' + oDs[ii].amount + '</td>' +
                            '<td class="hidden-xs">' + parseFloat(oDs[ii].rate).toFixed(5) + ' ' + baseCd.toUpperCase() + '</td>' +
                            '<td>' + (parseFloat(oDs[ii].amount) * parseFloat(oDs[ii].rate)).toFixed(2) + ' ' + baseCd.toUpperCase() + '</td>' +
                            '<td>' + bAc +
                        ...
                        $("#orderbookSep").after('<tr class="element-' + oDs[ii].coin + '-coin element-all-coin" style="background-color:#dcffdc;height: 40px;">' +
                            '<td style="width:100%;" ><img src="' + oDs[ii].tranTo.icon + '" style="width: 35px;float: left;position: relative;left: 20px;top: 5px;display: inline-block;"><span class="odbk-txt">' + oDs[ii].tranTo.name + '</span></td>' +
                            '<td class="hidden-xs">' + oDs[ii].amount + '</td>' +
                            '<td class="hidden-xs">' + parseFloat(oDs[ii].rate).toFixed(5) + ' ' + baseCd.toUpperCase() + '</td>' +
                            '<td>' + (parseFloat(oDs[ii].amount) * parseFloat(oDs[ii].rate)).toFixed(2) + ' ' + baseCd.toUpperCase() + '</td>' +
                            '<td>' + bAc +
