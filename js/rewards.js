...
activeCoin = getBitsOpt('coin');
    ...
    for (i = 0; i < tokenTab.length; i++) {
		...
		'<tr><th><a id="add-' + tokenTab[i] + '-buy-button" class="trade-new-Button waves-effect waves-light btn modal-trigger" href="#tradeOrder" style="width: 47.5%;margin-right:2.5px; position:relative; overflow:initial;" oid="new" act="buy" disabled><i class="material-icons left" style="margin: 0px 5px;">file_download</i>BUY</a>' +
            '<a class="trade-' + tokenTab[i] + '-Button trade-new-Button waves-effect waves-light btn modal-trigger" href="#tradeOrder" style="width: 47.5%;margin-left:2.5px;  position:relative;" oid="new" act="sell"><i class="material-icons right" style="margin: 0px 5px;">file_upload</i>SELL</a></th></tr>' +
