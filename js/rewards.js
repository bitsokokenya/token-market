...
$('.preloader-wrapper').css('display','none');
    ...
    console.log(getBitsWinOpt('uid'), CryptoJS.MD5(CryptoJS.MD5(oDs[ii].tranFrom.uid).toString()).toString());
    ...
    console.log(getBitsWinOpt('uid'),CryptoJS.MD5(CryptoJS.MD5(oDs[ii].tranTo.uid).toString()).toString());
